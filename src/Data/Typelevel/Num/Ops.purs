...
class Pred :: forall k. Type -> k -> Constraint
...
class Add :: forall k. Type -> Type -> k -> Constraint
...
class DivMod :: forall k1 k2. Type -> Type -> k1 -> k2 -> Constraint
...
class DivModP :: forall k1 k2 k3. Type -> Type -> k1 -> k2 -> k3 -> Constraint
...
class Mul10 :: forall k. k -> Type -> Constraint
...
class Div10 :: forall k. Type -> k -> Constraint
...
class IsDivBy :: forall k. Type -> k -> Constraint
...
class CS :: forall k1 k2 k3. k1 -> k2 -> k3 -> Constraint
...
class Eq :: forall k1 k2. k1 -> k2 -> Constraint
class Eq x y
...
class Gt :: forall k1 k2. k1 -> k2 -> Constraint
class Gt x y
...
class Lt :: forall k1 k2. k1 -> k2 -> Constraint
class Lt x y
...
class GtEq :: forall k1 k2. k1 -> k2 -> Constraint
class GtEq x y
...
class LtEq :: forall k1 k2. k1 -> k2 -> Constraint
class LtEq x y
...
class MaxP :: forall k1 k2 k3 k4. k1 -> k2 -> k3 -> k4 -> Constraint
...
class Max :: forall k1 k2 k3. k1 -> k2 -> k3 -> Constraint
...
class Min :: forall k1 k2 k3. k1 -> k2 -> k3 -> Constraint
...
class GCDP :: forall k1 k2. Type -> Type -> k1 -> k2 -> Type -> Constraint
...
class IsZero :: forall k1 k2. k1 -> k2 -> Constraint
